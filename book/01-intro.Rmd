...
opts <- c(
  x = "Quit RStudio", 
  answer="Menu: Session > Restart R", 
  x = "Click on the broom icon in the Environment tab",
  answer = "<span class=\"apple\">Cmd-Shift-F10</span> or <span class=\"windows\">Ctl-Shift-F10</span>",
  answer = "type `.rs.restartR()` in the console",
  x = "type `q()` in the console"
)

cat("* How do you restart R? (there may be more than one right answer)", longmcq(opts))
```
