...
First, create a new project for the work we'll do in this chapter named `r path("06-relations")`. Second, open and save a new R Markdown document named `relations.Rmd`, delete the welcome text, and load the required packages for this chapter.
