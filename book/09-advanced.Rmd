...
First, create a new project for the work we'll do in this chapter named `r path("09-advanced")`. Second, open and save a new R Markdown document named `visualisations.Rmd`, delete the welcome text and load the required packages for this section. You will probably need to install several new packages.
...
```{r anim-alternative, echo = FALSE, fig.caption = "This plot gives the same information at a single glance."}
worldpop %>%
