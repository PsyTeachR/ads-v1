...
```{r theme-font-demo, warning = FALSE, fig.width = 10, fig.height = 2.5, fig.cap="Different fonts."}
...
mono <- g + theme_bw(base_family = "mono") + 
  ggtitle("Mono")
fira <- g + theme_bw(base_family = "Fira Code") + 
  ggtitle("FiraCode")

sans + serif + mono + fira + plot_layout(nrow = 1)
```

However, you may have to add fonts first, especially if you're using Windows. The `r pkg("showtext")` package is a flexible way to add fonts.
...
```{r font-demo, warning = FALSE, fig.width = 8, fig.height = 2.5, fig.cap="Custom Fonts."}
...
```{r demo-multi-text, warning = FALSE, fig.width = 6, fig.height = 2.5, fig.cap="Multiple custom fonts on the same plot."}
