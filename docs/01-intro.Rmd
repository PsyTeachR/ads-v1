...
The right panes have several different tabs that show you information about your code. The most common tabs in the upper right pane are the **Environment** tab and the **Help** tab. The environment tab lists some information about the `r glossary("object", "objects")` that you have defined in your code. We'll learn more about the Help tab in Section\ \@ref(function-help). 
...
`r hide("Why are my numbers different to your numbers?")`
