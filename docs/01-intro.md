...
* How do you restart R? (there may be more than one right answer) <div class='webex-radiogroup' id='radio_CCSXASRQDN'><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="x"></input> <span>Quit RStudio</span></label><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="answer"></input> <span>Menu: Session > Restart R</span></label><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="x"></input> <span>Click on the broom icon in the Environment tab</span></label><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="answer"></input> <span><span class="apple">Cmd-Shift-F10</span> or <span class="windows">Ctl-Shift-F10</span></span></label><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="answer"></input> <span>type `.rs.restartR()` in the console</span></label><label><input type="radio" autocomplete="off" name="radio_CCSXASRQDN" value="x"></input> <span>type `q()` in the console</span></label></div>
