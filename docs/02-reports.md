...
**My name is Emily and I am 36 years old. It is 265 days until Christmas, which is my favourite holiday.**
...
Use inline R to include the version of R you are using in the following sentence: "This report was created using R version 4.1.3 (2022-03-10)." You can get the version using the object `R.version.string`. [\@ref(rmd-inline-r)]
