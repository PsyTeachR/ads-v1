...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_IZZHEZKDCW'><label><input type="radio" autocomplete="off" name="radio_IZZHEZKDCW" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_IZZHEZKDCW" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_IZZHEZKDCW" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_IZZHEZKDCW" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_IZZHEZKDCW" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_FTWYHBVACL'><label><input type="radio" autocomplete="off" name="radio_FTWYHBVACL" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_FTWYHBVACL" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_FTWYHBVACL" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_FTWYHBVACL" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
