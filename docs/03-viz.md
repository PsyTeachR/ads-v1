...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_KEKQTEWISQ'><label><input type="radio" autocomplete="off" name="radio_KEKQTEWISQ" value="answer"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_KEKQTEWISQ" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_KEKQTEWISQ" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_KEKQTEWISQ" value="x"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_KEKQTEWISQ" value="x"></input> <span>aes(y = population)</span></label></div>
...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_JLNNIUQIAO'><label><input type="radio" autocomplete="off" name="radio_JLNNIUQIAO" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_JLNNIUQIAO" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_JLNNIUQIAO" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_JLNNIUQIAO" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_JLNNIUQIAO" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_QKEPIPSRXH'><label><input type="radio" autocomplete="off" name="radio_QKEPIPSRXH" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_QKEPIPSRXH" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_QKEPIPSRXH" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_QKEPIPSRXH" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
