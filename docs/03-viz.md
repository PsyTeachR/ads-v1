...
## Walkthrough video {#walkthrough-viz}
...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_DRQWEOXZEL'><label><input type="radio" autocomplete="off" name="radio_DRQWEOXZEL" value="answer"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_DRQWEOXZEL" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_DRQWEOXZEL" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_DRQWEOXZEL" value="x"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_DRQWEOXZEL" value="x"></input> <span>aes(y = population)</span></label></div>
...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_KLKFRWKHVM'><label><input type="radio" autocomplete="off" name="radio_KLKFRWKHVM" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_KLKFRWKHVM" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_KLKFRWKHVM" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_KLKFRWKHVM" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_KLKFRWKHVM" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_UUTFYEJSJP'><label><input type="radio" autocomplete="off" name="radio_UUTFYEJSJP" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_UUTFYEJSJP" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_UUTFYEJSJP" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_UUTFYEJSJP" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
...
::: {.info data-latex=""}
These are not, by any means, all the plot types that you can make in R. This chapter just gave you a basic overview, and we will go into more detail in Chapter\ \@ref(custom-viz). The [further resources](#resources-viz) section at the end of this chapter lists many resources, but the [R Graph Gallery](http://www.r-graph-gallery.com/){target="_blank"} is an especially useful one to get inspiration for the kinds of beautiful plots you can make in R. 
:::
