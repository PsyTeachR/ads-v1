...
* What mapping would you use?  <div class='webex-radiogroup' id='radio_EZARHGZMHF'><label><input type="radio" autocomplete="off" name="radio_EZARHGZMHF" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_EZARHGZMHF" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_EZARHGZMHF" value="x"></input> <span>aes(x = country)</span></label><label><input type="radio" autocomplete="off" name="radio_EZARHGZMHF" value="answer"></input> <span>aes(x = island)</span></label><label><input type="radio" autocomplete="off" name="radio_EZARHGZMHF" value="x"></input> <span>aes(y = population)</span></label></div>
:::
...
* How would you set the mapping for these plots?  <div class='webex-radiogroup' id='radio_YRGCQPPBJE'><label><input type="radio" autocomplete="off" name="radio_YRGCQPPBJE" value="x"></input> <span>aes(x = country, y = population)</span></label><label><input type="radio" autocomplete="off" name="radio_YRGCQPPBJE" value="x"></input> <span>aes(x = population, y = country)</span></label><label><input type="radio" autocomplete="off" name="radio_YRGCQPPBJE" value="answer"></input> <span>aes(x = population)</span></label><label><input type="radio" autocomplete="off" name="radio_YRGCQPPBJE" value="x"></input> <span>aes(x = population, y = count)</span></label></div>
