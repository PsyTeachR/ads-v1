...
::: {.warning data-latex=""}
The example markdown above (and in the rest of this book) is shown for the regular editor, not the visual editor. In the visual editor, you won't see the hashes that create headers, or the asterisks that create bold and italic text. You also won't see the backticks that demarcate inline r code.

<div class="figure" style="text-align: center">
<img src="images/reports/visual-editor-example.png" alt="The example code above shown in the visual editor." width="50%" />
<p class="caption">(\#fig:visual-editor-example)The example code above shown in the visual editor.</p>
</div>

If you try to add the asterisks and backticks to the visual editor, you will get frustrated as they disappear. If you succeed, your code in the regular editor will look mangled like this:
...
You can also use the markdown shortcut `![caption](url)` to show an image. The caption is optional; you can omit it like this: 
